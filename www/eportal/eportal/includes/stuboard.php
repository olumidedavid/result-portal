...
# $_SESSION['staff_id'] = 16; 
 $query = mysqli_query($con,"select firstname, lastname from student where id='$student_id'");
...
<aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                ...
                <li class="menu-title">Hi,&nbsp;<?php echo $studentname;?></li>
                 ...
                 <li class="menu-item-has-children dropdown <?php if($page=='session'){ echo 'active'; }?>">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false"> <i class="menu-icon fa fa-cogs"></i>RESULT CHECKER</a>
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-plus"></i> <a href="midterm_results.php" target="_blank">Mid-Term Result</a></li>
                        <li><i class="fa fa-plus"></i> <a href="endterm_results.php" target="_blank">End of Term Result</a></li>
                    </ul>
                </li>
                   
                   <li class="menu-title">Result Ranking</li>
                    <li class="menu-item-has-children dropdown <?php if($page=='faculty'){ echo 'active'; }?>">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Rank by Subject</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-plus"></i> <a href="student_top_subjects.php" target="_blank">Subject Ranking</a></li>
                           <!-- <li><i class="fa fa-eye"></i> <a href="#">Meet Class Rep.</a></li>-->
                        </ul>
                    </li>
                    
                    <li class="menu-item-has-children dropdown <?php if($page=='department'){ echo 'active'; }?>">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false"> <i class="menu-icon fa fa-bars"></i>Support Ticket</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-plus"></i> <a href="#">Log Result Issue</a></li>
                            <li><i class="fa fa-eye"></i> <a href="#">Ticket Status</a></li>
                        </ul>
                    </li>
                    <!--
