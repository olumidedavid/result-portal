...
session_start();
    include 'db_inc.php';
    $pdo = pdoConnect();
    include 'olumphp/dataValues.php';
...
<body>
    <!-- Left Panel -->
    <?php $page="dashboard"; include 'includes/leftMenu_teacher.php';?>
    <!-- /#left-panel -->
    <!-- Right Panel -->
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h3 align="center"><b>Teachers Panel</b></h3>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        ...
                                        <span class="count"><?php echo $countAllClass ?? 0;?></span>
                                    </h3>
                                    <p class="text-light mt-1 m-0">Class Arms</p><!-- Log on to codeastro.com for more projects! -->
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-secondary">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?php echo $countAllResult;?></span>
                                    </h3>
                        ...
                        <div class="card text-white bg-danger">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Term</p><!-- Log on to codeastro.com for more projects! -->
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-info">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Classes</p><!-- Log on to codeastro.com for more projects! -->
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-primary">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?php echo $countAllSession ?></span>
                                    </h3>
                                    <p class="text-light mt-1 m-0">Session</p><!-- Log on to codeastro.com for more projects! -->
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-flat-color-6">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?php echo $diplomas['Upper Credit'] ?? 0?></span>
                                    </h3>
                                    <p class="text-light mt-1 m-0">Distinction</p><!-- Log on to codeastro.com for more projects! -->
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-flat-color-4">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?php echo $diplomas['Lower Credit'] ?? 0?></span>
                                    </h3>
                                    <p class="text-light mt-1 m-0">Ungraded</p><!-- Log on to codeastro.com for more projects! -->
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-flat-color-2">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?php echo $diplomas['Pass'] ?? 0?></span>
                                    </h3>
                        ...
                        <div class="card text-white bg-danger">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?php echo $diplomas['Fail'] ?? 0?></span>
                                    </h3>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                $result = $pdo->query("SELECT sessionName 
                                                      FROM session 
                                                      WHERE CURDATE() BETWEEN date_from AND date_until"); 
