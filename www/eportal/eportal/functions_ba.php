...
function stamp($pass)
{
    ...
    if ($pass) {
        ...
        <g transform='rotate($theta 50 50)'>
                ...
                <text x='50' y='58' class='svgtext' text-anchor='middle' fill='#ffffff' style='font-size: 20px; font-weight:600'>PASSED</text>
        </g>
        </svg>";
    }
    else {
        ...
        <g transform='rotate($theta 50 50)'>
            ...
            <text x='50' y='58' class='svgtext' text-anchor='middle' fill='#ffffff' style='font-size: 20px; font-weight:600;'>REPEAT</text>
        </g>
        </svg>";
    }
}
