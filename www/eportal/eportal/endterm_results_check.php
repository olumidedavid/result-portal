...
#$_SESSION['student_id'] = 37;                                                     # testing only

#$student = $_SESSION['student_id'] ?? 37                                          # testing only
    ...
    <div class='w3-container w3-padding ' id='wrapper'>
        ...
        <div class='w3-row'>
           ...
           <div class='w3-col w3-quarter w3-center'>
                <div class='w3-panel w3-blue summaryhead' >Students in class</div>
